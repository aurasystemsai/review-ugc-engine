// public/loader.js
// AURA • Universal Reviews Loader (Stable Build)
...
// - Opens admin in new tab for now (MVP version)
...
(function () {
  ...
  ready(async function () {
    try {
      ...
      // ---------------- 3. Fetch site config from backend ----------------
      const configUrl =
      ...
      if (!res.ok) {
        console.warn("[AURA] Config fetch failed:", res.status);
        return;
      }
